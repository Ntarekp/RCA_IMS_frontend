        ...
        <div className="max-w-[1600px] mx-auto space-y-8 animate-in fade-in duration-500 pb-10">
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                ...
                <div className="flex items-center gap-3 w-full md:w-auto">
                    ...
                    <button 
          onClick={onAddUser}
          className="flex items-center gap-2 bg-[#1e293b] dark:bg-[#155DFC] text-white px-5 py-2.5 rounded-xl text-sm font-medium hover:bg-slate-800 dark:hover:bg-[#155DFC]/90 transition-all shadow-lg shadow-slate-900/20 active:scale-95 whitespace-nowrap"
        >
                            ...
                            <div className="flex items-center gap-4">
                                <div className={`w-14 h-14 rounded-2xl flex items-center justify-center text-xl font-bold shadow-sm overflow-hidden ${
                                    user.role === 'ADMIN' 
                                        ...
                                        : 'bg-slate-100 dark:bg-[#155DFC]/20 text-[#1E293B] dark:text-[#155DFC]'
                                }`}>
                                    {user.avatarUrl ? (
